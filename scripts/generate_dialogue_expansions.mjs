...
const content = {
  es: {
    ...
    followUpPrompt: '¿Necesita algo más?',
    followUpResponse: 'No, eso es todo, gracias.',
    closingPrompt: '¡Que tenga un buen día!',
    closingResponse: 'Igualmente, hasta luego.',
  },
  en: {
    ...
    followUpResponse: "No, that's all, thank you.",
    closingPrompt: 'Have a nice day!',
    closingResponse: 'You too, goodbye.',
  },
  de: {
    ...
    followUpPrompt: 'Brauchen Sie noch etwas?',
    followUpResponse: 'Nein, das ist alles, danke.',
    closingPrompt: 'Einen schönen Tag noch!',
    closingResponse: 'Ihnen auch, auf Wiedersehen.',
  },
  it: {
    ...
    followUpPrompt: 'Ha bisogno di altro?',
    followUpResponse: 'No, è tutto, grazie.',
    closingPrompt: 'Buona giornata!',
    closingResponse: 'Anche a lei, arrivederci.',
  },
  pt: {
    ...
    followUpPrompt: 'Precisa de mais alguma coisa?',
    followUpResponse: 'Não, é tudo, obrigado.',
    closingPrompt: 'Tenha um bom dia!',
    closingResponse: 'Igualmente, até logo.',
  },
  nl: {
    ...
    followUpPrompt: 'Heeft u nog iets nodig?',
    followUpResponse: 'Nee, dat is alles, dank u.',
    closingPrompt: 'Nog een fijne dag!',
    closingResponse: 'U ook, tot ziens.',
  },
  pl: {
    ...
    followUpPrompt: 'Czy potrzebuje pan czegoś jeszcze?',
    followUpResponse: 'Nie, to wszystko, dziękuję.',
    closingPrompt: 'Miłego dnia!',
    closingResponse: 'Wzajemnie, do widzenia.',
  },
  tr: {
    ...
    followUpPrompt: 'Başka bir şeye ihtiyacınız var mı?',
    followUpResponse: 'Hayır, hepsi bu, teşekkürler.',
    closingPrompt: 'İyi günler!',
    closingResponse: 'Size de, hoşça kalın.',
  },
  ru: {
    ...
    followUpPrompt: 'Вам нужно что-нибудь ещё?',
    followUpResponse: 'Нет, это всё, спасибо.',
    closingPrompt: 'Хорошего дня!',
    closingResponse: 'И вам, до свидания.',
  },
  ja: {
    ...
    followUpPrompt: 'ほかに何か必要ですか。',
    followUpResponse: 'いいえ、以上です。ありがとうございます。',
    closingPrompt: '良い一日を。',
    closingResponse: 'あなたも。さようなら。',
  },
  ko: {
    ...
    followUpPrompt: '다른 것이 필요하세요?',
    followUpResponse: '아니요, 그게 전부예요. 감사합니다.',
    closingPrompt: '좋은 하루 보내세요!',
    closingResponse: '당신도요. 안녕히 계세요.',
  },
  zh: {
    ...
    followUpPrompt: '您还需要别的吗？',
    followUpResponse: '不用了，就这些，谢谢。',
    closingPrompt: '祝您今天愉快！',
    closingResponse: '您也是，再见。',
  },
  ar: {
    ...
    followUpPrompt: 'هل تحتاج إلى شيء آخر؟',
    followUpResponse: 'لا، هذا كل شيء، شكراً.',
    closingPrompt: 'أتمنى لك يوماً سعيداً!',
    closingResponse: 'ولك أيضاً، إلى اللقاء.',
  },
  hi: {
    ...
    followUpPrompt: 'क्या आपको कुछ और चाहिए?',
    followUpResponse: 'नहीं, बस इतना ही, धन्यवाद।',
    closingPrompt: 'आपका दिन शुभ हो!',
    closingResponse: 'आपका भी, अलविदा।',
  },
}
...
const french = {
  ...
  followUpPrompt: 'Avez-vous besoin d’autre chose ?',
  followUpResponse: 'Non, c’est tout, merci.',
  closingPrompt: 'Bonne journée !',
  closingResponse: 'À vous aussi, au revoir.',
}
