...
export function calcXp(mode: 'quiz' | 'cards' | 'fill-blank', correct: number, total: number): number {
  const perCorrect = mode === 'fill-blank' ? 7 : mode === 'cards' ? 3 : 5
