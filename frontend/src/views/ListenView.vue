...
.listen-hint { color: #aaa; margin-bottom: 1rem; font-size: .95rem; }
...
.reveal-term { font-size: 1.6rem; font-weight: 700; color: #fff; margin-bottom: 1rem; }
.reveal-term.rtl { direction: rtl; }
.reveal-rom { color: #888; font-size: .85rem; font-weight: 400; }
