...
.auth-card { background: #1e1e2e; border: 1px solid #333; border-radius: 12px;
...
input { width: 100%; background: #12121f; border: 1px solid #333; border-radius: 8px;
  color: #eee; padding: 0.6rem 0.75rem; font-size: 0.95rem; margin-bottom: 1rem;
  box-sizing: border-box; }
input:focus { outline: none; border-color: #4f46e5; }
button[type=submit] { width: 100%; background: #4f46e5; color: white; border: none;
...
.switch { text-align: center; margin-top: 1rem; color: #888; font-size: 0.9rem; }
