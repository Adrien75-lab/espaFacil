...
.card-front { background: #1e1e2e; border: 2px solid #333; }
.card-back  { background: #1a2e1a; border: 2px solid #22c55e40; transform: rotateY(180deg); }
.word-term { font-size: 2.2rem; font-weight: 700; color: #fff; text-align: center; }
.word-term.rtl { direction: rtl; }
.word-rom  { color: #888; font-size: 0.95rem; font-style: italic; }
...
.word-ex   { font-size: 0.82rem; color: #aaa; text-align: center; font-style: italic; }
...
.review-list { text-align: left; background: #1e1e2e; border-radius: 10px; padding: 0.75rem 1rem; margin-bottom: 1.5rem; }
.review-label { color: #888; font-size: 0.85rem; margin-bottom: 0.5rem; }
.review-item { display: flex; gap: 0.5rem; padding: 0.25rem 0; font-size: 0.9rem; }
.review-term { color: #fff; }
