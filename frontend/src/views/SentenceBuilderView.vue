...
.fr-hint {
  ...
  background: #1e1e2e; border: 2px solid #4f46e5;
...
.instruction { color: #888; font-size: .85rem; font-style: italic; text-align: center; margin-bottom: .75rem; }
...
.answer-zone.has-tokens { border-style: solid; border-color: #4f46e5; }
...
.word-token:hover:not(:disabled) {
  ...
  box-shadow: 0 3px 10px #4f46e540;
}
.word-token:active:not(:disabled) { transform: translateY(0); }
.word-token.in-zone { background: #4f46e5; color: #fff; border-color: #3730a3; }
...
.btn-next { background: #4f46e5; color: white; border: none; border-radius: 8px; padding: .55rem 1.4rem; font-size: .9rem; cursor: pointer; white-space: nowrap; }
